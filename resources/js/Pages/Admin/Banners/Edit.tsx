        ...
        <AdminLayout title="Edit Banner">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 w-full">
                ...
                <div className="bg-admin-surface shadow-sm shadow-admin-border/20 rounded-2xl border border-admin-border/50 p-6 space-y-6">
                    ...
                    <div>
                        <label className="block text-sm font-bold text-admin-text-muted mb-2 uppercase tracking-wide">Internal Name</label>
                ...
                <div className="bg-admin-surface shadow-sm shadow-admin-border/20 rounded-2xl border border-admin-border/50 p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-xs font-bold text-admin-text-muted mb-1">Eyebrow</label>
                        ...
                        {/* KM */}
                        <div className="space-y-4">
                            <h4 className="font-bold text-admin-text-muted font-khmer">Khmer</h4>
                            <div>
