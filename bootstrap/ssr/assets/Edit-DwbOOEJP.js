...
function Edit({ popup }) {
  const { data, setData, post, processing, errors } = useForm({
    ...
    creative_size: popup.creative_size || DEFAULT_POPUP_CREATIVE_SIZE,
    link_url: popup.link_url || "",
    button_label: popup.button_label || "Shop Now",
    accent_color: popup.accent_color || "#ff4c3b",
    starts_at: toDateInput(popup.starts_at),
    ends_at: toDateInput(popup.ends_at),
    is_active: Boolean(popup.is_active),
    image: null
  });
  const previewUrl = data.image ? URL.createObjectURL(data.image) : popup.image_url;
  ...
  const submit = (event) => {
    ...
    post(`/admin/popups/${popup.id}`, {
      forceFormData: true
    });
  };
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Edit Pop-up Ad", children: [
    /* @__PURE__ */ jsx(Head, { title: `Edit Pop-up Ad - ${popup.title}` }),
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-6 flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-2xl font-black text-admin-text", children: "Edit Pop-up Ad" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm font-semibold text-admin-text-muted", children: "Update the homepage popup content, image, button, and schedule." })
        ] })
      ] }),
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "rounded-2xl border border-admin-border bg-admin-surface p-5 shadow-sm", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
            /* @__PURE__ */ jsxs("label", { className: "block text-sm font-bold text-admin-text-muted sm:col-span-2", children: [
              "Internal Title",
              /* @__PURE__ */ jsx("input", { className: `${inputClass} mt-1.5`, value: data.title, onChange: (event) => setData("title", event.target.value), required: true }),
            ...
            /* @__PURE__ */ jsxs("label", { className: "block text-sm font-bold text-admin-text-muted sm:col-span-2", children: [
              "Public Heading",
              /* @__PURE__ */ jsx("input", { className: `${inputClass} mt-1.5`, value: data.heading, onChange: (event) => setData("heading", event.target.value) })
            ] }),
            /* @__PURE__ */ jsxs("label", { className: "block text-sm font-bold text-admin-text-muted sm:col-span-2", children: [
              "Description",
            ...
            /* @__PURE__ */ jsxs("label", { className: "block text-sm font-bold text-admin-text-muted", children: [
              "Button Text",
              /* @__PURE__ */ jsx("input", { className: `${inputClass} mt-1.5`, value: data.button_label, onChange: (event) => setData("button_label", event.target.value) })
            ] }),
            /* @__PURE__ */ jsxs("label", { className: "block text-sm font-bold text-admin-text-muted", children: [
              "Button Link",
              /* @__PURE__ */ jsx("input", { className: `${inputClass} mt-1.5`, value: data.link_url, onChange: (event) => setData("link_url", event.target.value) })
            ] }),
            /* @__PURE__ */ jsxs("label", { className: "block text-sm font-bold text-admin-text-muted", children: [
              "Starts At",
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-5 flex items-center gap-4 border-t border-admin-border pt-5", children: [
            ...
            /* @__PURE__ */ jsx("button", { disabled: processing, className: "ml-auto min-h-11 rounded-xl bg-admin-primary px-5 text-sm font-black text-white shadow-lg shadow-admin-primary/20 disabled:opacity-60", children: processing ? "Saving..." : "Save Changes" })
          ] })
        ] }),
