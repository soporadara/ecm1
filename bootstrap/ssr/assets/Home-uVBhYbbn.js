...
import { M as MainLayout, S as SupportFAB } from "./MainLayout-BSaLUdaW.js";
  ...
  return /* @__PURE__ */ jsxs(MainLayout, { title: "Home", description: "Logistics and Manual-Order Platform", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mt-auto", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-500 flex items-center gap-1", children: [
              /* @__PURE__ */ jsx(CheckCircle2, { className: "w-3.5 h-3.5 text-brand-primary" }),
              "Verified Customer"
            ] })
          ] })
        ] }),
    ...
    recentBlogs && recentBlogs.length > 0 && /* @__PURE__ */ jsx("section", { className: "py-20 bg-gray-50 dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: recentBlogs.map((post2) => /* @__PURE__ */ jsxs("article", { className: "group bg-white dark:bg-gray-950 rounded-[20px] overflow-hidden shadow-sm border border-gray-100 dark:border-gray-800 transition-all hover:shadow-xl hover:-translate-y-1", children: [
        /* @__PURE__ */ jsxs(Link, { href: `/blog/${post2.slug}`, className: "block relative aspect-video overflow-hidden bg-gray-100 dark:bg-gray-800", children: [
          ...
          post2.category && /* @__PURE__ */ jsx("div", { className: "absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-md text-[11px] font-bold text-brand-primary tracking-wide uppercase shadow-sm", children: post2.category.name })
        ] }),
    ...
    /* @__PURE__ */ jsx("section", { className: "py-20 bg-gray-50 dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto ui-card p-8 md:p-12", children: [
      ...
      /* @__PURE__ */ jsxs("form", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", onSubmit: (e) => {
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2", children: t("quote.origin", "Origin") }),
          ...
          errors.origin && /* @__PURE__ */ jsx("div", { className: "text-red-500 text-xs mt-1", children: errors.origin })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2", children: t("quote.destination", "Destination") }),
          /* @__PURE__ */ jsx("input", { type: "text", value: data.destination, onChange: (e) => setData("destination", e.target.value), className: "w-full rounded-xl border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-4 py-3 text-gray-900 dark:text-white focus:border-brand-primary focus:ring-brand-primary/50", placeholder: "e.g. Phnom Penh, Cambodia", required: true }),
          errors.destination && /* @__PURE__ */ jsx("div", { className: "text-red-500 text-xs mt-1", children: errors.destination })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2", children: t("quote.product_type", "Product Type") }),
          /* @__PURE__ */ jsx("input", { type: "text", value: data.product_type, onChange: (e) => setData("product_type", e.target.value), className: "w-full rounded-xl border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-4 py-3 text-gray-900 dark:text-white focus:border-brand-primary focus:ring-brand-primary/50", placeholder: "e.g. Electronics, Clothing", required: true }),
          errors.product_type && /* @__PURE__ */ jsx("div", { className: "text-red-500 text-xs mt-1", children: errors.product_type })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2", children: t("quote.quantity", "Quantity") }),
          /* @__PURE__ */ jsx("input", { type: "number", value: data.quantity, onChange: (e) => setData("quantity", e.target.value), className: "w-full rounded-xl border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-4 py-3 text-gray-900 dark:text-white focus:border-brand-primary focus:ring-brand-primary/50", placeholder: "e.g. 100", required: true }),
          errors.quantity && /* @__PURE__ */ jsx("div", { className: "text-red-500 text-xs mt-1", children: errors.quantity })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "md:col-span-2 grid grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2", children: t("quote.weight", "Weight (kg)") }),
            /* @__PURE__ */ jsx("input", { type: "text", value: data.weight, onChange: (e) => setData("weight", e.target.value), className: "w-full rounded-xl border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-4 py-3 text-gray-900 dark:text-white focus:border-brand-primary focus:ring-brand-primary/50", placeholder: "e.g. 50 kg" })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2", children: t("quote.dimensions", "Dimensions (cm)") }),
            /* @__PURE__ */ jsx("input", { type: "text", value: data.dimensions, onChange: (e) => setData("dimensions", e.target.value), className: "w-full rounded-xl border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-4 py-3 text-gray-900 dark:text-white focus:border-brand-primary focus:ring-brand-primary/50", placeholder: "L x W x H" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2", children: t("quote.shipping_method", "Preferred Shipping Method") }),
          /* @__PURE__ */ jsxs("select", { value: data.shipping_method, onChange: (e) => setData("shipping_method", e.target.value), className: "w-full rounded-xl border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 px-4 py-3 text-gray-900 dark:text-white focus:border-brand-primary focus:ring-brand-primary/50", children: [
            /* @__PURE__ */ jsx("option", { children: t("quote.method_standard", "Standard Delivery") }),
            /* @__PURE__ */ jsx("option", { children: t("quote.method_express", "Express Air Freight") }),
            /* @__PURE__ */ jsx("option", { children: t("quote.method_sea", "Sea Freight") }),
            /* @__PURE__ */ jsx("option", { children: t("quote.method_land", "Land Transport") })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
