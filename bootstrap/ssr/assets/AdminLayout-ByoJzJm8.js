...
function AdminLayout({ children, title, description, actions }) {
          ...
          /* @__PURE__ */ jsxs("header", { className: "sticky top-0 z-30 flex items-center justify-between border-b border-admin-border/40 bg-admin-bg/92 px-3 py-3 backdrop-blur-xl sm:px-4 md:static md:border-0 md:bg-transparent md:px-8 md:pb-4 md:pt-8 md:backdrop-blur-none", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 min-w-0", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "hidden md:block", children: isDashboard ? /* @__PURE__ */ jsxs(Fragment, { children: [
                  ...
                  /* @__PURE__ */ jsx("h1", { className: "text-2xl font-black text-admin-text", children: title || "Dashboard" }),
                  description && /* @__PURE__ */ jsx("p", { className: "text-[13px] text-admin-text-muted mt-1 font-medium", children: description })
                ] }) })
              ] })
            ] }),
