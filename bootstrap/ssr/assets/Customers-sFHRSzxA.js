...
function Customers({ customers, filters }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Logistics CRM - Customers", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "flex justify-between items-center mb-6", children: /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-admin-text tracking-tight", children: "Logistics Customers" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-admin-text-muted mt-1", children: "Select a customer to view or manage their manual orders." })
    ] }) }),
