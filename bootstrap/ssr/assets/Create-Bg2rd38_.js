...
import "react-dom";
import "lucide-react";
function Create({ categories, brands, collections }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Create Product", children: [
    /* @__PURE__ */ jsx(Head, { title: "Create Product - Admin" }),
    /* @__PURE__ */ jsxs("div", { className: "mb-6 flex items-center gap-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-gray-900 dark:text-white", children: "Create Product" }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 mt-1", children: "Add a new product to your catalog." })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800 shadow rounded-lg border border-gray-100 dark:border-gray-700 overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-6 space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2", children: "Short Description (15-35 words)" }),
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-gray-900 dark:text-gray-100 mb-2", children: "Full Description (HTML Supported)" }),
            /* @__PURE__ */ jsx("textarea", { rows: 6, value: data.description, onChange: (e) => setData("description", e.target.value), className: "w-full rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-800 px-4 py-3 text-sm shadow-sm transition-all focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20 dark:text-white" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-gray-100 dark:border-gray-700", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("input", { type: "text", value: data.material, onChange: (e) => setData("material", e.target.value), className: "w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-brand-primary focus:border-brand-primary", placeholder: "e.g. 100% Cotton" })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-gray-900 dark:text-gray-100 mb-2", children: "Care Instructions" }),
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-gray-900 dark:text-gray-100 mb-2", children: "Shipping Info" }),
              /* @__PURE__ */ jsx("input", { type: "text", value: data.shipping_info, onChange: (e) => setData("shipping_info", e.target.value), className: "w-full rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-800 px-4 py-3 text-sm shadow-sm transition-all focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20 dark:text-white" })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-gray-900 dark:text-gray-100 mb-2", children: "Return Info" }),
              /* @__PURE__ */ jsx("input", { type: "text", value: data.return_info, onChange: (e) => setData("return_info", e.target.value), className: "w-full rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-800 px-4 py-3 text-sm shadow-sm transition-all focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20 dark:text-white" })
            ] })
          ] })
        ] })
      ] }),
