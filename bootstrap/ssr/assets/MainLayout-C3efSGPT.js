...
function SupportFAB() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "fixed bottom-32 right-4 lg:bottom-6 lg:right-6 z-[110] flex flex-col items-end gap-3 pointer-events-none", children: [
      /* @__PURE__ */ jsx(
        "div",
        {
...
function SeoHead({ title, description, image, keywords }) {
  ...
  return /* @__PURE__ */ jsxs(Head, { children: [
    ...
    /* @__PURE__ */ jsx("link", { rel: "canonical", href: `https://mvmlogistics.asia${usePage().url.split("?")[0]}` })
  ] });
}
...
function MainLayout({ children, title, description, image, keywords }) {
  var _a, _b, _c;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-[100dvh] overflow-x-hidden bg-white font-sans antialiased text-brand-gray transition-colors duration-300 [--public-header-height:5rem] [--public-header-offset:5rem] dark:bg-gray-950 dark:text-gray-300 lg:[--public-header-height:6rem] lg:[--public-header-offset:6rem]", children: [
    /* @__PURE__ */ jsx(SeoHead, { title, description, image, keywords }),
